...
<!DOCTYPE html>
<html><head runat="server"><title>Reconciliation</title><link href="~/Styles/Site.css" rel="stylesheet" /></head>
<body><form id="form1" runat="server"><div class="page-header"><h1>Reconciliation</h1></div>
